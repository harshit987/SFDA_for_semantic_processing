...
def predict(predict_dir, output_dir):
    ...
    tokenizer = AutoTokenizer.from_pretrained('/content/drive/My Drive/SFDA/Time/model/task2_model_APM/1/',use_fast=True)
    model = AutoModelForTokenClassification.from_pretrained('/content/drive/My Drive/SFDA/Time/model/task2_model_APM/1/')
    print(3)
